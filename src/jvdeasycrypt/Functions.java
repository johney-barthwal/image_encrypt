...
public class Functions {
              ...
              static int outloop=3;
              static int decryptkeyset=2;
...
ImageIO.write(outputImage, formatName, new File(outputImagePath));
 ...
 public static void encrypt(String path,String encryptpath,String name)
 {
     try{ 
            generateKey();
            double bb;
         ...
         encryptpath=encryptpath+"/"+name+"_encrypt.png";
 ...
 public static void decrypt(String path,String decryptpath,int []setkey,String name)
 {        
     try
 {
      double bb;
            ...
            double st25=0.86,st26=0.31,st27=0.34,st28=0.58,st29=0.86,st30=0.90;
            int count =0;String s1,s2,s3;
           decryptpath=decryptpath+name+"_decrypt.png";
          File f=null;
           f= new File(path);
           int r,g,b,xx=1;
           image = ImageIO.read(f);
